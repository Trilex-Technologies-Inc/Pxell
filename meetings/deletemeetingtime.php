...
<tr class='odd'>
  ...
  <td><input type='submit' name='delete' class="btn btn-danger" value='" . $strings['delete'] . "'> 
    <input type='button' name='cancel' class="btn btn-secondary" value='" . $strings['cancel'] . "' onClick='history.back();'></td></tr>";
